...
import static com.example.eChanjoKE.backend.ConstantsAndStatics.ALARM_TYPE_SOUND_AND_VIBRATE;
import static com.example.eChanjoKE.backend.ConstantsAndStatics.ALARM_TYPE_SOUND_ONLY;
import static com.example.eChanjoKE.backend.ConstantsAndStatics.ALARM_TYPE_VIBRATE_ONLY;
...
import static com.example.eChanjoKE.backend.ConstantsAndStatics.BUNDLE_KEY_ALARM_ID;
...
import com.example.eChanjoKE.backend.AlarmBroadcastReceiver;
import com.example.eChanjoKE.backend.AlarmDatabase;
import com.example.eChanjoKE.backend.AlarmEntity;
import com.example.eChanjoKE.backend.ConstantsAndStatics;
import com.example.eChanjoKE.backend.Service_RingAlarm;
import com.example.eChanjoKE.backend.Service_SnoozeAlarm;
